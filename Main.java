public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(one.getScore()); // Expected: 2400
        ...
        System.out.println(two.getScore()); // Expected: 300

        Game five = new Game();
        System.out.println(five.playManyTimes(4)); // Will prompt for input 4 times
    }
}
